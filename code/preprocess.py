from data import show_mask, find_mask_labels, make_directories, make_mask_data
from data import mask_labels_after_process, show_mask_after_process
from data import split_data, make_train_data, make_validation_data
size = 256
root_dir = './car_data'
batch_size = 4
